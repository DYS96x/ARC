      ...
      <section className="max-w-5xl">
        ...
        <div className="mt-12 flex flex-wrap gap-4">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full !bg-cyan-300 px-8 py-4 !text-black font-bold shadow-lg shadow-cyan-500/30 transition-all duration-200 hover:!bg-cyan-200 hover:!text-black hover:scale-105"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/15 px-8 py-4 font-medium text-white transition hover:border-cyan-300 hover:text-cyan-300"
          >
